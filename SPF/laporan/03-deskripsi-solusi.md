...
| **Docker** | — | Kontainerisasi lingkungan pengujian untuk isolasi dan reproduktibilitas eksperimen. |
| **Google Colab** | — | Platform cloud untuk eksekusi notebook analisis final dengan resource GPU/CPU. |
